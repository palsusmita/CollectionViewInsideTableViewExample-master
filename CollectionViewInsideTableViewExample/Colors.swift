...
struct Colors {
    var objectsArray = [
        TableViewCellModel(
            ...
            colors: [
                // SubCategory #1.1
                [CollectionViewCellModel(color: UIColor.colorFromHex("#DA70D6"), name: "Orchid,Orchid,Orchid,Orchid,Orchid,Orchid,Orchid,Orchid,Orchid,Orchid,Orchid,Orchid,Orchid,Orchid"),
